# StartLink Space 0 UI System

This project contains a new **Space 0 Design System** located in `lib/core/presentation/widgets/space_0/` and `lib/features/design_showcase/`.

## Features Created

### 1. Physics-Based Levitation
- **Components**: `FloatingWidget`, `Space0Card`, `LevitatingListTile`.
...
### 2. 3D Interaction
- **Components**: `TiltableWidget` (integrated into `Space0Card`).
...
2. **Access the Showcase**:
   - On the initial **Login Screen**, search for the new text button at the bottom: **"View Space 0 System"** (with a rocket icon).
   - Tap it to launch the `Space0ShowcasePage`.
